...
REM
REM Generated by Vivado on Wed Oct 23 23:46:48 +0530 2024
...
echo "xvlog --incr --relax -prj macs_axi4s_tb_vlog.prj"
call xvlog  --incr --relax -prj macs_axi4s_tb_vlog.prj -log xvlog.log
